...
function getApi(sourceSchema, paramSet) {
  const auth = paramSet.apiConfig.keyFilename ? google.auth.fromJSON(require(paramSet.apiConfig.keyFilename)) : google.auth.fromJSON(require(paramSet.apiConfig.keyJson));
